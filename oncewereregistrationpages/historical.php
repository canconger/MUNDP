...
<html lang="en">
  <head>
    ...
    <title><?= TITLE ?>: Historical Committee Registration</title>
  ...
  <body>
    ...
    <div class="jumbotron registration">
        ...
        <div class="container">
            <h1>Historical Committee Registration</h1>
            <? if($regisetting['historical']) { ?>
            <p>Please register as an Historical Committee member from the form below.</p>
        ...
        <div class="register-section">
          ...
          <hr>
            <div class="form-group">
  					  <label class="control-label">*Which cabinet do you prefer?</label>
              <select class="form-control" name="cabinet">
                <option value="The Polish-Lithuanian Commonwealth">The Polish-Lithuanian Commonwealth</option>
                <option value="The Swedish Crown">The Swedish Crown</option>
              </select>
  					</div>
        </div>
				<div class="register-section">
					...
					<p><small>Please write a letter of motivation below that entails your past and future MUN experiences, your interest in historical events and your motives in applying to a Historical Committee position at MUNDP 2018. The letter of application should be at most 500 words.</small></p>
					<div class="form-group">
                ...
                <div class="register-section">
                    <input type="hidden" name="form" value="historical">
        ...
        <? } else { ?>
        <p>Historical Committee registration is now closed for MUNDP 2018.</p>
        <? } ?>
        </div> <!-- /container -->
