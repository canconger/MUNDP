...
<html lang="en">
  ...
  <body>
    ...
    <div class="jumbotron executive">
        <div class="container">
            <h1>UNODA</h1>
			<h2>United Nations Office for Disarmament Affairs</h2>
        </div>
    </div>
    ...
    <p><strong>Report 1</strong> <i>by Kaan Altınay</i><br>
      ...
      <a href="../reports20/UNODA1.pdf" class="btn btn-success btn-sm" target="_blank">Download the Report</a></p>
    <p><strong>Report 2</strong> <i>by Doğa Ayar</i><br>
      Addressing the power shift from national armies to militiast<br>
      <a href="../reports20/UNODA2.pdf" class="btn btn-success btn-sm" target="_blank">Download the Report</a></p>
    ...
    Taking measures against the development and proliferation of nuclear weapons<br>
      <a href="../reports20/UNODA3.pdf" class="btn btn-success btn-sm" target="_blank">Download the Report</a></p>
