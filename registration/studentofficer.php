...
<html lang="en">
  ...
  <body>
    ...
    <div class="jumbotron registration">
        ...
        <div class="container">
            <h1>Student Officer Registration</h1>
            <? if($regisetting['stoff']) { ?>
            <p>Please register as a student officer from the form below.</p>
            ...
            <form action="registration.php" method="post" id="schoolform" accept-charset="UTF-8">
				...
				<div class="register-section">
					...
					<p><small>Please write a paragraph (of 400 words at most) that summarizes your ideas about the Sustainable Development Goals. Also, all applicants should feel free to submit their previous MUN work in addition to their essay.</small></p>
					<div class="form-group">
					  <label class="control-label">*SDG Letter</label>
					  <textarea class="form-control" name="mdgletter" style="resize: vertical;" rows="10" required></textarea>
					</div>

					<br><br>

					<p><small>Please write a letter of motivation below that entails your past and future MUN experiences, and your motives in applying to a student officer position at MUNDP 2018. The letter of application should be at least 300 and at most 500 words.</small></p>
					<div class="form-group">
					  <label class="control-label">*Letter of Motivation</label>
					  <textarea class="form-control" name="applicationletter" style="resize: vertical;" rows="10" required></textarea>
					</div>

          <br><br>

					<p><small>You can submit your previous MUN work here. This is not required but strongly recommended.</small></p>
					<div class="form-group">
					  <label class="control-label">Previous MUN Work</label>
					  <textarea class="form-control" name="previouswork" style="resize: vertical;" rows="10" required></textarea>
					</div>
        </div>

				<div class="register-section">
                    <h2>Committee Preferences</h2>
                    <p><small>Please visit <a href="../development-committees" target="_blank">list of development committees</a> and <a href="../special-committees" target="_blank">list of special committees</a> for committee descriptions and agendas.</small></p>
					...
					<div class="row">
                        ...
                        <div class="col-xs-12 col-md-4">
                            <div class="form-group">
							  <label class="control-label">Preference <?= $i+1 ?></label>
                              <select class="form-control" name="pref<?= $i+1 ?>">
								<? foreach($committes as $data) { ?>
								<option value="<?= $data["id"]?>"><?= $data["name"]." (".$data["abbr"].")" ?></value>
								<? } ?>
                              </select>
                            </div>
                        </div>
				...
				<div class="register-section">
                    ...
                    <p><small>Please have your MUN advisor submit a letter of recommendation to <a href="mailto:recommendation@modelundp.org">recommendation@modelundp.org</a>. Applicants without recommendations will not be considered. If there are more than one applicant from a school, the advisor should rank the students in his/her e-mail.</small></p>
                    <div class="form-group">
                ...
                <div class="register-section">
                    <input type="hidden" name="form" value="studentofficer">
        ...
        <? } else { ?>
        <p>Student Officer registration is now closed for MUNDP 2018. Elected student officers will be announced via email.</p>
        <? } ?>
      </div>
    </div>
