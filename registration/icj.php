...
<html lang="en">
  ...
  <body>
    ...
    <div class="jumbotron registration">
        ...
        <div class="container">
            <h1>ICJ Registration</h1>
            <? if($regisetting['icj']) { ?>
            <p>Please register as an ICJ committee member from the form below.</p>
            ...
            <form action="registration.php" method="post" id="schoolform" accept-charset="UTF-8">
				...
				<div class="register-section">
                        ...
                        <div class="col-xs-12 col-md-4">
                            <div class="form-group">
                              ...
                              <select class="form-control" name="pref<?= $i+1 ?>">
								<? foreach($positions as $data) { if(in_array($data["id"],$icjposs)) { ?>
								<option value="<?= $data["id"]?>"><?= $data["name"] ?></value>
								<? } } ?>
                              </select>
                            </div>
                        </div>
					...
					<div class="row">
                        <div class="col-xs-12 col-md-6">
                            <div class="form-group">
							  <label class="control-label">If one of the preferences is Advocate, please state the name of your co-advocate</label>
							  <input class="form-control" name="coacvoacte" type="text">
                            </div>
                        </div>
						<div class="col-xs-12 col-md-6">
                            <div class="form-group">
							  <label class="control-label">Did you apply for a student officer position as well?</label>
							  <select class="form-control" name="studentofficer">
                ...
                <div class="register-section">
                            <h2>Letter (only if one of your preferences is Advocate, Registrar, President or Vice President)</h2>

                            <hr>

        					<p><small>Please write a letter of motivation below that entails your past and future MUN experiences and your motives in applying to a ICJ position at MUNDP 2018. The letter of application should be at most 500 words.</small></p>
        					<div class="form-group">
				...
				<div class="register-section">
                    ...
                    <p><small>Please have your MUN advisor submit a letter of recommendation to <a href="mailto:recommendation@modelundp.org">recommendation@modelundp.org</a>. Applicants without recommendations will not be considered. If there are more than one applicants from a school, the advisor should rank the students in his/her e-mail.</small></p>
                    <div class="form-group">
                ...
                <div class="register-section">
                    <input type="hidden" name="form" value="icj">
            ...
            <? } else { ?>
            <p>ICJ registration is now closed for MUNDP 2018.</p>
            <? } ?>
        </div> <!-- /container -->
