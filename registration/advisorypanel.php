...
<html lang="en">
  <head>
    ...
    <title><?= TITLE ?>: Advisory Panel Registration</title>
  ...
  <body>
    ...
    <div class="jumbotron registration">
        ...
        <div class="container">
            <h1>Advisory Panel Registration</h1>
            <? if($regisetting['historical']) { ?>
            <p>Please register as an Advisory Panel member from the form below.</p>
            ...
            <form action="registration.php" method="post" id="schoolform" accept-charset="UTF-8">
				...
				<div class="register-section">
                  ...
                  <option value="2018">2018</option>
					...
					<p><small>Please write a letter of motivation below that entails your past and future MUN experiences, your interest in world issues and this year's AP issues. The letter of application should be at most 500 words.</small></p>
					<div class="form-group">
        ...
        <? } else { ?>
        <p>Advisory Panel registration is now closed for MUNDP 2018.</p>
        <? } ?>
        </div> <!-- /container -->
