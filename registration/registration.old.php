    ...
    <div class="container">
        <div class="row">
            <div class="col-md-4 col-sm-6 col-xs-12 margin-bottom-24">
                <a href="school" class="btn btn-primary btn-lg btn-block"><h4><strong>School Registration</strong></h4><small>Registration is Open Until December 1st</small></a>
            </div>
            <div class="col-md-4 col-sm-6 col-xs-12 margin-bottom-24">
                <a href="studentofficer" class="btn btn-primary btn-lg btn-block"><h4><strong>Student Officer Registration</strong></h4><small>Registration is Open Until November 1st</small></a>
            </div>
            <div class="col-md-4 col-sm-6 col-xs-12 margin-bottom-24">
        ...
        <h4>About Registration and MyDP Service</h4>
        <p>After registration, in order to verify your contact information, a validation e-mail will be sent by us. After verification of your participation to MUNDP, you will be able to access the “MyDP” service.</p>
        <p>On your MyDP page, you will be able to enroll your delegates and advisors. In order to keep updated, please use give us the e-mail address that you check frequently.</p>
        <p>Your contacts will be protected by the MUNDP and will not be shared with any third parties.</p>
